...
describe "Coin", ->
  ...
  it 'should verify transaction signature', (done) ->
    FakeBlockchain.addCoins {
      "a2e85c628edb9ab4b29e55b17f69ab2af652e186ec38eb650381e87c370a7721:2":
        txId: 'a2e85c628edb9ab4b29e55b17f69ab2af652e186ec38eb650381e87c370a7721'
        outputIndex: 2
    ...
    .then (tx) ->
      ...
      for player, playerInputs of inputs
        Object.assign signatures, coin.getTransactionSignature(tx, playerInputs, secretKeys)
      signature = signatures['a2e85c628edb9ab4b29e55b17f69ab2af652e186ec38eb650381e87c370a7721:2']
      pubkey1 = '0236ceb580e9613ff718f17f3f1294508c68decf848b23cca7c75c2ed49ec69601'
      pubkey2 = '029b8a2373a5ba52817527e092be091fdbac499cf160d048d1966161a1fec30842'
      txHash = 'a2e85c628edb9ab4b29e55b17f69ab2af652e186ec38eb650381e87c370a7721:2'
      assert.ok coin.verifyTransactionSignature(signature, tx, pubkey1, txHash)
